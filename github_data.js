...
const lookupValue = "8030403992";
for (let i = 0; i < githubData.length; i++) {
    // console.log(githubData[i].id)
    // console.log(githubData[i].payload.commits)

    if (githubData[i].id === lookupValue) {
        console.log("***********************************************")
        console.log(`******here it is event ID ${githubData[i].id}`)
        console.log("***********************************************")
